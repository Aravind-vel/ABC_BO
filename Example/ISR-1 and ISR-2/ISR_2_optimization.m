...
problem_details.cat_var_lev_labels = {{'1','2','3','4','5'}}; % levels of the categorical variables
...
for i = 1:numel(field_names)
    ...
    yield(i) = ISR_2_insilico(temp, time, reag_eq, cat_load,str2num(catalyst));
...
%     yield(end+1) = ISR_2_insilico(temp, time, reag_eq, cat_load, str2double(catalyst));
% 
%     % objective calculation
